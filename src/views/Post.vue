  ...
  <div class="post">
    ...
    <div v-if="post">
      <div
        class="header"
        :style="[{
          backgroundImage: `url(${imageUrlFor(post.poster)})`,
          backgroundPosition: `${(post.poster.hotspot.x - post.poster.crop.left) * 100}% ${(post.poster.hotspot.y - post.poster.crop.top) * 100}%`
          }
        ]"
      >
      ...
      <div class="content">
        <div class="sidebar">
          <img
            class="poster"
            :src="imageUrlFor( post.poster ).ignoreImageParams().width(500)"
        ...
        <div class="main-content">
          ...
          <h2>Details</h2>
          <ul class="list">
            <li v-for="details in post.details" :key="details._key">
              <router-link :to="{name: 'post', params: {id: details.post._id}}">
                <img
                  v-if="details.post.image"
                  :src="imageUrlFor(details.post.image).ignoreImageParams().width(240)"
                />
